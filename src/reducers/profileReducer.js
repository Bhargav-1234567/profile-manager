...
const initialState = {
  profiles: [
    ...
    },
    {
      ...
      name: "Darshan",
      age: "23",
      bio: "Maecenas hac elementum lorem blandit nostra placerat vulputate per. Ultricies mattis libero vehicula natoque elit euismod convallis habitant? Luctus amet massa tempor neque torquent. Varius ultricies sollicitudin natoque; porttitor senectus consectetur conubia. Iaculis augue dictum tincidunt et leo. Tempus vel facilisi, vehicula luctus ut mollis orci. Erat rhoncus congue hac mi fringilla nulla himenaeos. Pretium libero odio cursus nibh vehicula torquent. Purus phasellus accumsan lectus elit suspendisse quisque. Proin mattis rhoncus feugiat vehicula ligula lacus bibendum donec.",
      gender: "male",
    },
  ],
};
